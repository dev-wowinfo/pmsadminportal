  ...
  return (
    <>
      <Card>
        ...
        <CardBody>
          <Row md={12} className="notification-box d-flex justify-content-center notifcation-container">
        ...
        <CardBody>
          ...
          <Row md={12} className="notification-box d-flex justify-content-center notifcation-container ">
            ...
            <div data-slot="card-content" className=" text-card-foreground flex flex-col gap-6 rounded-xl py-2 border-2 transition-all bg-warning/10 border-warning/20 px-3">
              {/* <div class="d-flex  gap-4"> */}

              <div className="d-flex justify-content-between space-y-2">
                  ...
                  <div className="d-flex justify-between gap-4">
                    <div className="flex-1">
                      <div className="d-flex items-center gap-2 mb-1">
                        <h3 className="font-semibold">License Expiring Soon</h3>
                         <p className="d-flex justify-center rounded border px-1 font-medium bg-primary text-white">New</p>
                      </div>
                      <p className="text-sm text-foreground/80">The license for Grand Plaza Hotel will expire in 25 days. Consider reaching out to discuss renewal options.</p><p class="text-xs text-muted-foreground mt-2">Hotel: Grand Plaza Hotel</p>
                      <div className="d-flex items-center gap-4 text-xs text-muted-foreground"><span>Jun 20, 2024 14:30</span>
                        <span data-slot="badge" className="small-box inline-flex items-center justify-center rounded border px-2 py-0.5 ">Expiry</span>
                      </div>
                    </div>
          ...
          <Row md={12} className="notification-box d-flex justify-content-center notifcation-container mt-3">
            <div data-slot="card-content" className="text-card-foreground flex flex-col gap-6 rounde py-2 border-2 transition-all bg-warning/10 border-warning/20 px-3 ">
              {/* <div class="d-flex  gap-4"> */}
              ...
              <div className=" d-flex justify-content-between space-y-2">
                ...
                <div className="d-flex">
                  ...
                  <div className="d-flex justify-between gap-4">
                    <div className="flex-1">
                      <div className="d-flex items-center gap-2 mb-1">
                        <h3 className="font-semibold text-foreground">Trial Period Ending</h3>
                         <p className="d-flex justify-center rounded border px-1 font-medium bg-primary text-white">New</p>
                      </div>
                      <p className="text-sm text-foreground/80">Mountain View Lodge's trial period will end in 7 days. This is a good opportunity to convert them to a paid subscription.</p><p class="text-xs text-muted-foreground mt-2">Hotel: Mountain View Lodge</p>
                      <div className="d-flex items-center gap-4 text-xs text-muted-foreground"><span>Mar 24, 2024 15:30</span>
                        <span data-slot="badge" className="small-box inline-flex items-center justify-center rounded border px-2 py-0.5 ">Trial Ending</span>
                      </div>
                    </div>
          ...
          <Row md={12} className="notification-box d-flex justify-content-center notifcation-container mt-3">
            <div data-slot="card-content" className="text-card-foreground flex flex-col gap-6 rounded-xl py-2 border-2 transition-all bg-warning/10 border-warning/20 px-3 bg-pink">
              {/* <div class="d-flex  gap-4"> */}
                ...
                <div className="d-flex">
                  ...
                  <div className="d-flex justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-foreground/80">Automatic renewal payment for City Center Suites has failed. The license is now in grace period. Please contact the customer immediately.</p><p class="text-xs text-muted-foreground mt-2">Hotel: City Center Suites</p>
                      <div className="d-flex items-center gap-4 text-xs text-muted-foreground"><span>Feb 21, 2024 12:00</span>
                        <span data-slot="badge" className="small-box inline-flex items-center justify-center rounded border px-2 py-0.5 ">Payment Failed</span>
                      </div>
                    </div>
